...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">教研室教学网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <!-- <li><a href="<%=basePath %>Teacher/frontlist.aspx">教师</a></li>-->
                <li><a href="<%=basePath %>TestPaper/frontlist.aspx">试卷查询</a></li>
                <li><a href="<%=basePath %>CourseReport/frontlist.aspx">课设报告</a></li>
                <li><a href="<%=basePath %>Practice/frontlist.aspx">实习报告</a></li>
                <li><a href="<%=basePath %>Laboratory/frontlist.aspx">实验报告</a></li>
                <li><a href="<%=basePath %>Teaching/frontlist.aspx">教学日历</a></li>
                <li><a href="<%=basePath %>Material/frontlist.aspx">教学资料</a></li>
                <!--<li><a href="<%=basePath %>LoanInfo/frontlist.aspx">资料借阅</a></li>-->
                <li><a href="<%=basePath %>Meeting/frontlist.aspx">会议记录</a></li>
                <!--<li><a href="<%=basePath %>Year/frontlist.aspx">学年信息</a></li>-->
                <li><a href="<%=basePath %>Score/frontlist.aspx">成绩查询</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>Teacher/frontAdd.aspx"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>LoanInfo/frontTeacherList.aspx"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的借阅</a></li>
                        <!--
                        <li><a href="<%=basePath %>index.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的收藏</a></li>
                        <li><a href="<%=basePath %>index.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发</a></li>
                        <li><a href="<%=basePath %>index.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的信息</a></li>-->
                        <li><a href="<%=basePath %>Teacher/frontSelfModify.aspx"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
