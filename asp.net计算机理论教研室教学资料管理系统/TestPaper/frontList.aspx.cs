...
using System.Data;
public partial class TestPaper_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?yearObj=" + yearObj.SelectedValue.Trim()+ "&&teamInfo=" + teamInfo.Text.Trim()+ "&&courseNo=" + courseNo.Text.Trim()+ "&&courseName=" + courseName.Text.Trim() + "&&teacherObj=" + teacherObj.SelectedValue.Trim()+ "&&className=" + className.Text.Trim()+ "&&putDate=" + putDate.Text.Trim());
        }
