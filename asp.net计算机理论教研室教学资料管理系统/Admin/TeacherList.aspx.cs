...
namespace chengxusheji.Admin
{
    public partial class TeacherList : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("TeacherList.aspx?teacherNo=" + teacherNo.Text.Trim() + "&&name=" + name.Text.Trim()+ "&&birthDate=" + birthDate.Text.Trim()+ "&&telephone=" + telephone.Text.Trim());
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            sb.Append("<thead><tr><th colSpan='8'>教师记录</th></tr>");
            sb.Append("<tr class='title'>");
            sb.Append("<th>教师工号</th>");
            sb.Append("<th>姓名</th>");
            sb.Append("<th>性别</th>");
            sb.Append("<th>出生日期</th>");
            sb.Append("<th>老师照片</th>");
