<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseReportList.aspx.cs" Inherits="chengxusheji.Admin.CourseReportList" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>课程设计报告列表</title>
...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">课程设计报告管理 》》课程设计报告列表</div>
    ...
    <asp:Repeater ID="RpCourseReport" runat="server" onitemcommand="RpCourseReport_ItemCommand">
        <HeaderTemplate>
        ...
        <ItemTemplate>
            <tr>
                <td align="center"><input type="checkbox" value='<%#Eval("reportId") %>' name="CheckMes" id="DelChecked"/></td>
                <td align="center"><%#Eval("reportId")%> </td>
                ...
                <td align="center"><%#Eval("fenshu")%> </td>
                ...
                <td align="center"><a href="CourseReportEdit.aspx?reportId=<%#Eval("reportId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("reportId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
