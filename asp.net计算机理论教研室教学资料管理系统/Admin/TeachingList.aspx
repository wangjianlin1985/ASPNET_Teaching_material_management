<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeachingList.aspx.cs" Inherits="chengxusheji.Admin.TeachingList" %>
...
<body>
   <form id="form1" runat="server">
    <div class="div_All">
    <div class="Body_Title">教学日历管理 》》教学日历列表</div>
    ...
    <asp:Repeater ID="RpTeaching" runat="server" onitemcommand="RpTeaching_ItemCommand">
        <HeaderTemplate>
        ...
        <ItemTemplate>
            <tr>
                <td align="center"><input type="checkbox" value='<%#Eval("teachingId") %>' name="CheckMes" id="DelChecked"/></td>
                ...
                <td align="center"><a href="TeachingEdit.aspx?teachingId=<%#Eval("teachingId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("teachingId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
