  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="teacher_regTime_edit" class="col-md-3 text-right">注册时间:</label>
		  	 <div class="col-md-9">
                <div class="input-group date teacher_regTime_edit col-md-12" data-link-field="teacher_regTime_edit">
                    <input class="form-control" id="teacher_regTime_edit" name="teacher.regTime" size="16" type="text" value="" placeholder="请选择注册时间" readonly>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                </div>
		  	 </div>
	...
	$.ajax({
		...
		success : function (teacher, response, status) {
			if (teacher) {
				...
				$("#teacher_regTime_edit").val(teacher.regTime);
...
$(function(){
    ...
    /*注册时间组件*/
    $('.teacher_regTime_edit').datetimepicker({
    	language:  'zh-CN',  //语言
